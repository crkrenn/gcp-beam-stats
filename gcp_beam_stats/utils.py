...
Adapted from:
https://github.com/googleapis/python-pubsub/blob/main/samples/snippets/publisher.py & # noqa: E501
https://github.com/googleapis/python-pubsub/blob/main/samples/snippets/subscriber.py 
"""
from collections.abc import Iterable

# Note: many commented lines were in the orginal code, 
# but were removed for "production"
...
def list_subscriptions_in_topic(project_id: str, topic_id: str) -> None:
    ...
    # response = publisher.list_topic_subscriptions(request={"topic": topic_path}) # noqa: E501
...
def create_subscription(
        project_id: str, topic_id: str, subscription_id: str) -> None:
